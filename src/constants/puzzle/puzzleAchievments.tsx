...
import { EPuzzleAchievments } from "./EPuzzleAchievments";
...
} from "../../components/layout/icons/Achievments/puzzle/SaveWin";
import {
  AchievmentWin1Level,
  AchievmentWin2Level,
  AchievmentWin3Level,
  AchievmentWin4Level,
  AchievmentWin5Level,
} from "../../components/layout/icons/Achievments/puzzle/Win";
import {
...
} from "../../components/layout/icons/Achievments/puzzle/WinInRow";

const { win, winInRow, saveWin } = TRANSLATIONS.puzzle.achievments;

export const PUZZLE_ACHIEVMENTS = {
  [EPuzzleAchievments.WIN]: [
    {
