...
import GameClanCreateIcon from "../../../layout/icons/game/GameClanPage/GameClanMain/GameClanCreateIcon";
import GameClanFindIcon from "../../../layout/icons/game/GameClanPage/GameClanMain/GameClanFindIcon";
import GameClansList from "../../../layout/icons/game/GameClanPage/GameClansList/GameClansList";
import { CLANS } from "../../../../dummyData/clans";
import styles from "./GameClanMain.module.scss";
    ...
    <section className={styles.gameClanMain}>
      <WrapperWithFrame size="md">
        ...
        >
          ...
          <div className={styles.gameClanMain__createBlock}>
            ...
            <button className={styles.gameClanMain__btn}>
              <div
                onClick={() => navigate(`${gamePagePath}/${gameCreateClanPagePath}`)}
        ...
        >
          ...
          <button
            onClick={() => navigate(`${gamePagePath}/${gameClanSearchPagePath}`)}
