...
import styles from "./RPGGameCharacterTraining.module.scss";
...
import RPGGameCharacterTrainingInfo from "./RPGGameCharacterTrainingInfo/RPGGameCharacterTrainingInfo";
...
const trainingTabs = [
  {
    ...
    content: <RPGGameCharacterTrainingDevelopment />,
    info: [
      {
  ...
  },
  {
    ...
    content: <RPGGameCharacterTrainingCybernetics />,
    info: [
      {
        title: "Механика Прокачки Персонажа",
        text: "В Dystopia RPG прогресс зависит не от времени, а от действий игрока. Каждое решение, каждый бой — это шаг вперёд в эволюции бойца. Система прокачки строится вокруг трёх ключевых направлений: характеристики, параметры и приёмы",
  ...
  },
  {
    ...
    content: <RPGGameCharacterTrainingRedistribution />,
    info: [
      {
        title: "Механика Прокачки Персонажа",
        text: "В Dystopia RPG прогресс зависит не от времени, а от действий игрока. Каждое решение, каждый бой — это шаг вперёд в эволюции бойца. Система прокачки строится вокруг трёх ключевых направлений: характеристики, параметры и приёмы",
...
const RPGGameCharacterTraining: React.FC<Props> = ({ activeTab }) => {
  ...
  return (
    <WrapperWithFrame className={styles.rpgGameCharacterTraining} size="lg">
      <div className={styles.rpgGameCharacterTraining__main}>
        <TransitionProvider
          className={styles.rpgGameCharacterTraining__header}
          inProp={gameInited}
          style={TransitionStyleTypes.top}
          height={86}
        >
          <h5 className={styles.rpgGameCharacterTraining__headerTitle}>
            {isInfoOpen
...
export default RPGGameCharacterTraining;
